...
class CountryController extends Controller
{
    public function country()
    {
        ...
        //return $countries;
        return view('support.country.country',compact('countries','parent_countries'));
    }
    ...
    public function state()
    {
        ...
        return view('support.country.state',compact('states','countries'));
    }
    ...
    public function city()
    {
        ...
        return view('support.country.city',compact('cities','countries'));
    }
    ...
    public function zipcode()
    {
        ...
        return view('support.country.zipcode',compact('countries','zipcodes','near_by'));
    }
