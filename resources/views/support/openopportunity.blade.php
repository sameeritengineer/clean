...
@section('title','Assign a Job')
@section('content')
<div class="app-content content container-fluid">
  <div class="content-wrapper">
    <div class="content-header row">
       <div class="content-header-left col-md-6 col-xs-12 mb-2">
        <h3 class="content-header-title mb-0">Assign a Job</h3>
                    ...
                    <table class="table table-striped table-bordered zero-configuration">
                      ...
                      <tbody>
                        ...
                        <tr id="unapprovedprovider{{$Opportunite->id}}">
                          ...
                          <td><a href="{{route('support::show_opportunity',[$Opportunite->id])}}" class="btn btn-warning">Assign To</a></td>
                        </tr>
                         @endforeach
                      </tbody>
                    </table>
