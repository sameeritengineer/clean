            ...
            <div class="card">
              <div class="card-body collapse in">
                <div class="card-block ">
                  ...
                  @endif
                  <form class="form-horizontal" action="{{route('support::users.create')}}" method="post" enctype="multipart/form-data" novalidate>
                  @csrf
                    <div class="row">
                      <div class="col-md-12">    
                        <div class="row">
...
$('.country').change(function()
{
  ...
  if(countryID)
  {
    ...
    ({
      type:"GET",
      url:"{{url('support/get-state-list')}}?country_id="+countryID,
...
$('.state').change(function()
{
  ...
  if(StateID)
  {
    ...
    ({
      type:"GET",
      url:"{{url('support/get-city-list')}}?state_id="+StateID,
      success:function(res)
      {
        if(res)
        {
...
$('.city').change(function()
{
  ...
  if(cityID)
  {
    ...
    ({
      type:"GET",
      url:"{{url('support/get-zipcode-list')}}?city_id="+cityID,
      success:function(res)
      {
        if(res)
        {
