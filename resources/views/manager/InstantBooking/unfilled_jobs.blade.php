...
function get_state_list(country_id)
{
  ...
  var url = "{{url('manager/get_unfilled_jobs_state')}}/"+country_id;
  $.ajax
  ({
    type: "get",   
    url: url,             
...
{ 
  ...
  $('.append_provider_list').html('');
  $('.open_opportunity').css('display','none');
  var url = "{{url('manager/get_unfilled_jobs_city')}}/"+id;
  $.ajax
  ({
    type: "get",   
    url: url,             
...
function get_jobs_lists(city_id)
{
  ...
  $('.append_jobs').html('');
  $('.append_provider_list').html('');
  var url = "{{url('manager/get_unfilled_jobs')}}/"+city_id;
  $.ajax
  ({
    type: "get",   
    url: url,             
...
{
  $('.append_provider_list').html('');
  var url = "{{url('manager/get_provider_zipcode')}}";
  $.ajax
  ({
    type: "post",   
    url: url,             
