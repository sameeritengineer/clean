...
@section('title','Declined Provider')
@section('content')
    ...
    <div class="content-wrapper">
      <div class="content-header row">
         <div class="content-header-left col-md-6 col-xs-12 mb-2">
          <h3 class="content-header-title mb-0">All Declined Service Provider</h3>
                ...
                <div class="card-body collapse in">
                  <div class="card-block card-dashboard">
                    ...
                    <table class="table table-striped table-bordered zero-configuration">
                      ...
                      <tbody>
                        @foreach($AllDeclineProvider as $unapprovedprovider)
                        <tr id="unapprovedprovider{{$unapprovedprovider->id}}">
                          ...
                          <td><button type="button" class="btn btn-icon btn-primary" data-id="" data-url="" onclick="deleteConfirm({{$unapprovedprovider->id}},'{{route('destroyunApprovedProvider')}}');" data-toggle="modal" data-target="#default"><i class="ft-trash"></i></button></td>
                        </tr>
                        @endforeach 
                      </tbody>  
                    </table>
