  ...
  <div class="content-wrapper data">
    <div class="content-header row">
      <div class="content-header-left col-md-6 col-xs-12 mb-2">
        <h3 class="content-header-title mb-0">Approve Provider Profile</h3>
                          ...
                          <tr>
                            ...
                            <td>
                              @if($profile->status == 0)
                                ...
                                <button type="button" onclick="changeStatus('{{$profile->id}}',2)" class="btn btn-primary">Decline</button>
                              @endif
                              @if($profile->status == 1)
