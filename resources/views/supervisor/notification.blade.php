  ...
  <div class="content-wrapper">
    ...
    <div class="content-header row">
      <div class="content-header-left col-md-6 col-xs-12 mb-2">
        <h3 class="content-header-title mb-0">Send Notification to all customers</h3>
      </div>  
              ...
              <div class="card">
                <div class="card-body collapse in">
                  <div class="card-block">
                      ...
                      @endif
                     <form class="form form-horizontal form-bordered" action="{{route('supervisior::send_notic_to_all_customers')}}" method="post" enctype="multipart/form-data" novalidate>
                       @csrf
                      <div class="form-body">  
