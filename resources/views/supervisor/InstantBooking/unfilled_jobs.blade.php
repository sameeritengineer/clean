                    ...
                    <div class="tab-content tab-country-wrapper">
                      <div class="tab-pane show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                        <div class="container-fluid">
                          ...
                          <div class="row"><div class="append_cities"></div></div>
...
function get_state_list(country_id)
{
  ...
  var url = "{{url('supervisior/get_unfilled_jobs_state')}}/"+country_id;
  $.ajax
  ({
    type: "get",   
    url: url,             
...
{ 
  ...
  $('.append_provider_list').html('');
  $('.open_opportunity').css('display','none');
  var url = "{{url('supervisior/get_unfilled_jobs_city')}}/"+id;
  $.ajax
  ({
    type: "get",   
    url: url,             
...
function get_jobs_lists(city_id)
{
  ...
  $('.append_jobs').html('');
  $('.append_provider_list').html('');
  var url = "{{url('supervisior/get_unfilled_jobs')}}/"+city_id;
  $.ajax
  ({
    type: "get",   
    url: url,             
...
{
  $('.append_provider_list').html('');
  var url = "{{url('supervisior/get_provider_zipcode')}}";
  $.ajax
  ({
    type: "post",   
    url: url,             
