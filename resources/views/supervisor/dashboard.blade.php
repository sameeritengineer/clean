    ...
    <div class="content-header row"></div>
      <div class="content-body">       
        <div class="row">
          ...
          <a href="{{route('supervisior::OpenOpportunity')}}">
          ...
          <a href="{{route('supervisior::viewAllCurrentRunningJobs')}}">
          <div class="col-xl-3 col-lg-6 col-xs-12">
              <div class="card">
                  <div class="card-body">
                    <div class="media">
            ...
            <a href="{{route('supervisior::viewAllCompletedJobs')}}">
            <div class="col-xl-3 col-lg-6 col-xs-12">
              <div class="card">
                  <div class="card-body">
                    <div class="media">
            ...
            <a href="{{route('supervisior::viewAllProviderCanceledJobs')}}">            
            <div class="col-xl-3 col-lg-6 col-xs-12">
              <div class="card">
                  <div class="card-body">
                    <div class="media">
            ...
            <a href="{{route('supervisior::viewAllCustomerCanceledJobs')}}"> 
            <div class="col-xl-3 col-lg-6 col-xs-12">
              <div class="card">
                  <div class="card-body">
                    <div class="media">
